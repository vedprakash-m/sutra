...
class TestCostManagementAPI:
    ...
    @pytest.mark.asyncio
    @patch("api.cost_management_api.get_enhanced_budget_manager")
    async def test_cost_prediction_success(self, mock_get_manager, mock_budget_manager):
    ...
    @pytest.mark.asyncio
    @patch("api.cost_management_api.get_enhanced_budget_manager")
    async def test_cost_estimation_success(self, mock_get_manager, mock_budget_manager):
        ...
        mock_budget_manager.estimate_execution_cost = AsyncMock(
            return_value={
                "model": "gpt-4",
        ...
        mock_budget_manager.check_pre_execution_budget = AsyncMock(
            return_value={
                "within_budget": True,
    ...
    @pytest.mark.asyncio
    @patch("api.cost_management_api.get_enhanced_budget_manager")
    async def test_budget_configuration_update(
        self, mock_get_manager, mock_budget_manager
    ):
        ...
        mock_budget_manager.create_budget_config = AsyncMock(
            return_value=Mock(
    ...
    @pytest.mark.asyncio
    @patch("api.cost_management_api.get_enhanced_budget_manager")
    async def test_budget_manager_error_handling(
        self, mock_get_manager, mock_budget_manager
    ):
    ...
    @pytest.mark.asyncio
    @patch("api.cost_management_api.get_enhanced_budget_manager")
    async def test_anomaly_detection_endpoint(
        self, mock_get_manager, mock_budget_manager
    ):
