...
class TestPromptsAPI:
    ...
    async def test_handle_get_prompts_success(self, mock_get_db_manager, mock_get_user, mock_request, valid_user_id):
    ...
    async def test_handle_create_prompt_success(self, mock_validator, mock_get_db_manager, mock_get_user, mock_request, sample_prompt_data, valid_user_id):
    ...
    @pytest.mark.asyncio
    @patch("api.prompts.get_current_user")
    async def test_handle_create_prompt_invalid_json(self, mock_get_user, mock_request, valid_user_id):
    ...
    @patch("api.prompts.get_current_user")
    @patch("api.prompts.get_database_manager")
    async def test_handle_update_prompt_success(self, mock_get_db_manager, mock_get_user, mock_request, sample_prompt_data, valid_user_id):
    ...
    @patch("api.prompts.get_current_user")
    @patch("api.prompts.get_database_manager")
    async def test_handle_update_prompt_not_found(self, mock_get_db_manager, mock_get_user, mock_request, sample_prompt_data, valid_user_id):
    ...
    @patch("api.prompts.get_current_user")
    @patch("api.prompts.get_database_manager")
    async def test_handle_delete_prompt_success(self, mock_get_db_manager, mock_get_user, mock_request, valid_user_id):
    ...
    @patch("api.prompts.get_current_user")
    @patch("api.prompts.get_database_manager")
    async def test_handle_delete_prompt_not_found(self, mock_get_db_manager, mock_get_user, mock_request, valid_user_id):
    ...
    async def test_handle_get_prompts_with_pagination(self, mock_validate_pagination, mock_get_user, mock_request, valid_user_id):
