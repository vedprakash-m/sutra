...
class AuditLogger:
    ...
    def _involves_personal_data(self, event: AuditEvent) -> bool:
        ...
        personal_data_resources = [
            "user", "profile", "contact", "analytics", "prompt", "collection"
        ]
    ...
    def _generate_compliance_summary(self, events: List[AuditEvent], 
    ...
    def _analyze_risk_patterns(self, events: List[AuditEvent]) -> Dict[str, Any]:
        ...
        risk_analysis["security_incidents"] = sum(
...
def audit_log(event_type: AuditEventType, action: str, resource_type: str, 
