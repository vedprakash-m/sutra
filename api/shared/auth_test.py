...
from api.shared.auth import (
    ...
    get_auth_manager, extract_token_from_request, require_auth,
    require_admin, get_current_user, check_admin_role,
    check_user_permissions, get_user_role, require_admin_role,
    require_permission, verify_jwt_token, get_user_id_from_token
)
...
class TestAuthManager:
    ...
    async def test_get_auth_config_success(self, mock_credential, mock_secret_client):
        ...
        mock_client_instance.get_secret.side_effect = [tenant_secret, client_secret, policy_secret]
