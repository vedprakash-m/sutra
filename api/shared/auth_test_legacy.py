...
class TestAuthManager:
    ...
    def test_init(self):
        ...
        assert auth_manager.simple_manager is not None
        assert hasattr(auth_manager, "simple_manager")

    @pytest.mark.skip(reason="Legacy test - kv_client property no longer exists in current AuthManager")
    ...
    @pytest.mark.asyncio
    @pytest.mark.skip(reason="Legacy test - get_auth_config method no longer exists in current AuthManager")
    @patch("api.shared.auth.SecretClient")
    @patch("api.shared.auth.DefaultAzureCredential")
    ...
    @patch("api.shared.auth.SecretClient")
    @patch("api.shared.auth.DefaultAzureCredential")
    @pytest.mark.skip(reason="Legacy test - get_auth_config method no longer exists")
    async def test_get_auth_config_fallback(self, mock_credential, mock_secret_client):
        ...
        with patch.dict(os.environ, {"KEY_VAULT_URI": "https://test-kv.vault.azure.net/"}):
            ...
            assert config["client_secret"] == "mock-secret"  # pragma: allowlist secret
    ...
    @pytest.mark.asyncio
    @pytest.mark.skip(reason="Legacy test - validate_token async behavior changed")
    ...
    @pytest.mark.asyncio
    @pytest.mark.skip(reason="Legacy test - method signature changed")
    ...
    async def test_check_permission_admin(self):
        ...
        assert auth_manager.check_permission(user, "prompts", "create")
        assert auth_manager.check_permission(user, "admin", "manage_users")
    ...
    async def test_check_permission_user(self):
        ...
        assert auth_manager.check_permission(user, "prompts", "create")
        assert auth_manager.check_permission(user, "collections", "read")

        # User should not have admin permissions
        assert not auth_manager.check_permission(user, "admin", "manage_users")


class TestAuthFunctions:
    """Test suite for authentication utility functions."""

    @pytest.mark.skip(reason="Legacy test - get_auth_manager no longer implements singleton pattern")
    ...
    @pytest.mark.skip(reason="Legacy test - verify_jwt_token function signature changed")
    ...
    @pytest.mark.skip(reason="Legacy test - function behavior changed")
    ...
    @pytest.mark.skip(reason="Legacy test - check_admin_role function behavior changed")
