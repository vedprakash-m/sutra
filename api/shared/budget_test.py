...
class TestBudgetManager:
    ...
    async def test_get_budget_alerts_critical(self, mock_get_db_manager):
        ...
        budget_manager.check_provider_budget = AsyncMock(side_effect=[
        ...
        budget_manager.check_user_budget = AsyncMock(side_effect=[
            user_budget_critical,  # user-123
            user_budget_ok         # user-456
        ])
