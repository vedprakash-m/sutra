...
class TestDatabaseManager:
    ...
    def test_init_with_connection_string(self):
        ...
        with patch.dict(os.environ, {'COSMOS_DB_CONNECTION_STRING': 'AccountEndpoint=https://test.documents.azure.com:443/;AccountKey=test_key;'}):
    ...
    def test_init_without_connection_string_production(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            with pytest.raises(ValueError, match="COSMOS_DB_CONNECTION_STRING environment variable is required"):
                DatabaseManager()
...
class TestGlobalFunctions:
    ...
    def test_get_cosmos_client(self, mock_cosmos_client):
        ...
        with patch.dict(os.environ, {'ENVIRONMENT': 'production', 'COSMOS_DB_CONNECTION_STRING': 'AccountEndpoint=https://test.documents.azure.com:443/;AccountKey=test_key==;'}):
