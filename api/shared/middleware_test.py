...
class TestRateLimitMiddleware:
    ...
    def test_rate_limit_middleware_exception(self):
        ...
        with patch('api.shared.middleware.get_client_ip', side_effect=Exception("IP error")), \
...
class TestEnhancedSecurityMiddleware:
    ...
    def test_enhanced_security_middleware_exception(self):
        ...
        with patch('api.shared.middleware.validate_cors_origin', side_effect=Exception("CORS error")), \
             patch('api.shared.middleware.rate_limit_middleware') as mock_rate_middleware, \
             patch('api.shared.middleware.logger') as mock_logger:
