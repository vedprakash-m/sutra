...
class RateLimiter:
    ...
    def check_rate_limit(self, identifier: str, rule_names: List[str] = None, 
                        user_id: str = None, ip_address: str = None, 
                        endpoint: str = None) -> Tuple[bool, List[RateLimitStatus]]:
        ...
        for rule_name in rule_names:
            ...
            scope_identifier = self._get_scope_identifier(
                rule.scope, identifier, user_id, ip_address, endpoint
            )
    ...
    def _is_exempt(self, rule: RateLimitRule, user_id: str = None, 
    ...
    def _get_scope_identifier(self, scope: RateLimitScope, identifier: str, 
                             user_id: str = None, ip_address: str = None, 
    ...
    def _check_rule(self, rule: RateLimitRule, identifier: str, 
                   user_id: str = None, ip_address: str = None, 
    ...
    def _check_adaptive(self, rule: RateLimitRule, key: str, 
                       user_id: str = None, ip_address: str = None, 
                       endpoint: str = None) -> RateLimitStatus:
    ...
    def record_request_result(self, identifier: str, success: bool, 
        ...
        if rule_names is None:
            rule_names = [name for name, rule in self.rules.items() 
...
def rate_limit(rule_names: List[str] = None, 
            ...
            try:
                ...
                if not is_allowed:
                    ...
                    headers = {
                        ...
                        "Retry-After": str(int(max((s.reset_time - datetime.utcnow()).total_seconds() for s in statuses if s.is_limited)))
                    }
