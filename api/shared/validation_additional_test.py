...
from api.shared.validation import (
    ...
    validate_safe_string, validate_content, validate_json_field,
    validate_pydantic_model, validate_pagination_params, validate_search_query,
    validate_user_permissions, validate_resource_ownership,
    MAX_STRING_LENGTH, MAX_CONTENT_LENGTH, MAX_TAGS_COUNT, MAX_TAG_LENGTH,
    EMAIL_PATTERN, IDENTIFIER_PATTERN, SAFE_STRING_PATTERN
)
