...
from api.forge_api.idea_refinement_endpoints import analyze_idea, complete_stage, get_quality_assessment, refine_idea_with_llm
from api.shared.quality_engine import ContextualQualityValidator, QualityAssessmentEngine
...
@pytest.fixture
def mock_user_info():
    return {"user_id": "test-user-123", "organization_id": "test-org-456", "role": "developer"}
...
def sample_project_context():
    return {"complexity": "medium", "project_type": "mvp", "user_experience": "intermediate"}
...
class TestQualityEngine:
    ...
    def test_idea_quality_scoring(self, sample_idea_data, sample_project_context):
        ...
        result = engine.calculate_quality_score(
            stage="idea_refinement", content=sample_idea_data, context=sample_project_context
        )
    ...
    def test_improvement_suggestions(self, sample_idea_data, sample_project_context):
        ...
        result = engine.calculate_quality_score(stage="idea_refinement", content=weak_idea, context=sample_project_context)
...
class TestIdeaRefinementEndpoints:
    ...
    async def test_analyze_idea_success(
        self, mock_quality_engine, mock_extract_user, mock_user_info, sample_idea_data, sample_project_context
    ):
        ...
        # Create request
        request_body = {"ideaData": sample_idea_data, "projectContext": sample_project_context}

        request = MockHttpRequest(method="POST", body=request_body, route_params={"project_id": "test-project-123"})
...
class TestQualityGateLogic:
    ...
    def test_quality_gate_blocking_logic(self):
        ...
        result = engine.calculate_quality_score(stage="idea_refinement", content=weak_idea, context={"complexity": "medium"})
    ...
    def test_quality_gate_excellence_logic(self):
        ...
        result = engine.calculate_quality_score(
            stage="idea_refinement", content=excellent_idea, context={"complexity": "medium"}
        )
