...
try:
    ...
    class CodingAgentOptimizer:
        ...
        def generate_context_optimized_prompts(self, project_context, focus_area='full-stack', optimization_level='production'):
...
class TestImplementationPlaybookGeneration:
    ...
    def sample_project_context(self):
        ...
        return {
            ...
            "ux_requirements": {
                ...
                "user_journeys": [
                    "Login → Dashboard → Create Task → Assign → Track Progress"
                ],
    ...
    def test_generate_context_optimized_prompts(self, coding_optimizer, sample_project_context):
        ...
        expected_prompts = [
            'project_setup', 'architecture_implementation', 'frontend_development',
            'backend_development', 'api_development', 'database_implementation',
            'testing_implementation', 'deployment_automation'
        ]
    ...
    def test_create_systematic_workflow(self, coding_optimizer, sample_project_context):
        ...
        workflow = coding_optimizer.create_systematic_workflow(
            ...
            workflow_methodology='agile_sprints'
        )
    ...
    def test_optimize_for_coding_agents(self, coding_optimizer):
        ...
        optimized = coding_optimizer.optimize_for_coding_agents(
    ...
    def test_generate_coding_prompts_function(self, sample_project_context):
        ...
        result = generate_coding_prompts(
            project_context=sample_project_context,
            optimization_level='production'
        )
    ...
    def test_quality_context_integration(self, coding_optimizer, sample_project_context):
        ...
        prompts = coding_optimizer.generate_context_optimized_prompts(
            project_context=sample_project_context
        )
    ...
    def test_workflow_methodology_options(self, coding_optimizer, sample_project_context):
        ...
        for methodology in methodologies:
            workflow = coding_optimizer.create_systematic_workflow(
                ...
                ux_specs=ux_specs,
                requirements=requirements,
                workflow_methodology=methodology
            )
