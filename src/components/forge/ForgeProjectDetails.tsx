...
const STAGES = [
  {
    ...
    description: 'Transform concepts into structured opportunities with systematic clarification',
    icon: SparklesIcon,
    color: 'indigo'
  },
  {
  ...
  },
  {
    ...
    description: 'Create user experience specifications and interface design requirements',
    icon: ClockIcon,
    color: 'blue'
  },
  {
    ...
    description: 'Multi-LLM technical architecture evaluation and stack recommendations',
    icon: CogIcon,
    color: 'orange'
  },
  {
    ...
    description: 'Generate step-by-step coding agent prompts and execution guides',
    icon: PlayCircleIcon,
    color: 'purple'
  }
] as const;
...
export default function ForgeProjectDetails({ project, onBackToList, onProjectUpdate }: ForgeProjectDetailsProps) {
  const [activeTab, setActiveTab] = useState<'overview' | 'work' | 'artifacts' | 'collaboration' | 'analytics'>('overview');
  ...
  const tabs = [
    ...
    { id: 'artifacts', name: `Artifacts (${project.artifactsCount})`, icon: DocumentTextIcon },
    { id: 'collaboration', name: `Team (${project.collaboratorsCount})`, icon: UserGroupIcon },
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${PRIORITY_COLORS[project.priority]}`}>
      ...
      <div className="mb-8 bg-white rounded-lg border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-lg font-semibold text-gray-900">Project Stages</h2>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        {activeTab === 'overview' && (
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Current Stage: {currentStage.name}</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-indigo-600">{project.progressPercentage}%</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div>
              ...
              <div className="space-y-2">
                {project.currentStage === 'idea_refinement' && (
                  <>
                    <p className="text-gray-600">• Multi-dimensional idea analysis (market, technical, user, competitive)</p>
                    <p className="text-gray-600">• Stakeholder interview automation using selected LLM</p>
                    <p className="text-gray-600">• Market research synthesis and opportunity statement generation</p>
                  </>
                )}
                {project.currentStage === 'prd_generation' && (
                  <>
                    <p className="text-gray-600">• Intelligent requirement extraction and validation</p>
                    <p className="text-gray-600">• User story generation with acceptance criteria</p>
                    <p className="text-gray-600">• Feature prioritization with business impact scoring</p>
                  </>
                )}
                {project.currentStage === 'ux_requirements' && (
                  <>
                    <p className="text-gray-600">• User journey mapping and wireframe generation</p>
                    <p className="text-gray-600">• Prototype generation and design system integration</p>
                    <p className="text-gray-600">• Accessibility compliance checking</p>
                  </>
                )}
                {project.currentStage === 'technical_analysis' && (
                  <>
                    <p className="text-gray-600">• Multi-LLM technical architecture evaluation</p>
                    <p className="text-gray-600">• Architecture comparison and recommendation engine</p>
                    <p className="text-gray-600">• Comprehensive feasibility assessment across all configured LLMs</p>
                  </>
                )}
                {project.currentStage === 'implementation_playbook' && (
                  <>
                    <p className="text-gray-600">• Generate coding-agent-optimized prompts</p>
                    <p className="text-gray-600">• Create step-by-step development workflow</p>
                    <p className="text-gray-600">• Generate testing strategy and deployment procedures</p>
                  </>
                )}
              </div>
            </div>
          ...
          <div>
            ...
            {project.currentStage === 'prd_generation' && (
              <div className="text-center py-12">
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-900">PRD Generation Stage</h3>
                <p className="mt-1 text-sm text-gray-500">
                  Coming soon - Generate comprehensive Product Requirements Document
                </p>
              </div>
            )}
            {project.currentStage === 'ux_requirements' && (
              <div className="text-center py-12">
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-900">UX Requirements Stage</h3>
                <p className="mt-1 text-sm text-gray-500">
            ...
            {project.currentStage === 'technical_analysis' && (
              <div className="text-center py-12">
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-900">Technical Analysis Stage</h3>
                <p className="mt-1 text-sm text-gray-500">
            ...
            {project.currentStage === 'implementation_playbook' && (
              <ImplementationPlaybookStage
                ...
                onStageComplete={(data) => {
                  setStageData(prev => ({ ...prev, implementation_playbook: data }));
                  handleAdvanceStage();
                }}
        ...
        {activeTab === 'artifacts' && (
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Project Artifacts</h3>
            <div className="text-center py-12">
              <DocumentTextIcon className="mx-auto h-12 w-12 text-gray-400" />
        ...
        {activeTab === 'collaboration' && (
          <div>
            ...
            <div className="text-center py-12">
              <UserGroupIcon className="mx-auto h-12 w-12 text-gray-400" />
              <h3 className="mt-2 text-sm font-medium text-gray-900">Solo project</h3>
              <p className="mt-1 text-sm text-gray-500">
