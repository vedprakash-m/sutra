      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white shadow rounded-lg p-6">
            <h2 className="text-lg font-medium text-gray-900 mb-4">Playbook Details</h2>
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setPlaybookData(prev => ({ ...prev, visibility: e.target.value as 'private' | 'shared' }))}
                  className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                >
          ...
          <div className="bg-white shadow rounded-lg p-6">
            ...
            {playbookData.steps.length === 0 ? (
              <div className="text-center py-12">
                ...
                <h3 className="mt-4 text-lg font-medium text-gray-900">Build Your First Workflow</h3>
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center">
                        ...
                        <span className="ml-2 text-sm text-gray-500">Step {index + 1}</span>
                      </div>
                      <button
