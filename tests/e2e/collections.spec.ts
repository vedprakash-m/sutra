...
test.describe('Collections Management', () => {
  ...
  test('should create new collection', async ({ page }) => {
    ...
    await page.fill('[data-testid="collection-description"]', 'A test collection')
  ...
  test('should search prompts', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="prompt-list"] .prompt-item')).toContainText('marketing')
  })
})
