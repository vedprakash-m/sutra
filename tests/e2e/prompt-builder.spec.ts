...
test.describe('Prompt Builder', () => {
  test('should create a new prompt', async ({ page }) => {
    ...
    await page.fill('[data-testid="intention-input"]', 'Write a marketing email')
    await page.selectOption('[data-testid="tone-select"]', 'persuasive')
    await page.fill('[data-testid="prompt-text"]', 'Act as a marketing expert and write a persuasive email for {{product_name}}')
  ...
  test('should save prompt to collection', async ({ page }) => {
    ...
    await page.selectOption('[data-testid="collection-select"]', 'My Collection')
